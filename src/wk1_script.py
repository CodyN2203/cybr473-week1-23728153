'''
Scripting Assignment #1 - String Search Operations 
'''
...
A user on ChirpyHub posted a hacker manifesto.
An excerpt from it is already assigned to the variable 'excerpt' below.
...
6) Submit your repository in GitHub Classroom with this file edited and screenshots.
   ...
   B) A short video using Zoom or a Screen Recorder of your choice showing you committing and pushing the screenshot to GitHub using PyCharm.
